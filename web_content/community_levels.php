...
$sql_com = "SELECT `TrialName`, `Creator`, `Rating`, `Difficulty`, `TrialData`  FROM `community_trial_list` ORDER BY `TrialName` ASC";
...
function makeTable($tnms, $crs, $rats) {
    ...
    foreach ($tnms as $nm) {
        ...
        $ret .= "<button onclick=\"doedit('" . $nm . "')\" class=\"btn-link\">Edit</button></td><td>";
...
<div id="makebutton" class="row">
    ...
    <div class="col-xs-2">
        <form action="levelmaker.php" method="post">
            <input id="makebuttoncl" type="submit" value="Make your own!">
...
<form id="moveform" action="community_playground.php" method="post" style="display: none">
